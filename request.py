...
class Message:
    def __init__(self, message_type, payload, options=0, client_ip=None, server_ip=None):
        """
    ...
    def calculate_checksum(self):
        ...
        checksum = zlib.crc32(payload_data) & 0xFFFFFFFF
        return checksum
    ...
    def from_bytes(cls, data):
        ...
        This function deserializes a byte representation of the message back into object
        Converts the byte-array received from the netwrok into a structured message"""
        message_type = data[0]
